  ...
  return {
    ...
    completion: (async () => {
      try {
        ...
        // dump any old SVG content
        svgViewerEl.innerHTML = '';
        
        // create a download link wrapping the SVG image
        const svgURL = URL.createObjectURL(svgBlob);
        const link = document.createElement('a');
        link.href = svgURL;
        link.download = svgName;            // sets the downloaded filename
        link.title = 'Click to download SVG';
